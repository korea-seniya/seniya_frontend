...
import { getMyInfo, updateMyInfo, deleteMyInfo } from "../../apis/userInfo/userInfo";
    ...
    <>
      ...
      <div css={pageWrapperStyle}>
        ...
        <div css={containerStyle}>
          ...
          <button css={withdrawButtonStyle} onClick={handleUpdate}>
            수정 완료
          </button>
          <button css={deleteButtonStyle} onClick={() => setShowDeleteModal(true)}>
            회원 탈퇴
          </button>
          ...
          {showDeleteModal && (
            <div css={modalOverlayStyle}>
              <div css={modalBoxStyle}>
                ...
                <button css={confirmButtonStyle} onClick={handleDelete}>
                  탈퇴하기
                </button>
                <button css={cancelButtonStyle} onClick={() => setShowDeleteModal(false)}>
                  취소
                </button>
              </div>
            </div>
