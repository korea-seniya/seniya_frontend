...
function TrainerApplication() {
  ...
  const onSubmit = async () => {
    await trainerApply();
    alert("신청 완료");
    navigate("/trainer-application/me");
  };
    ...
    <>
      ...
      <div css={containerStyle}>
        <div css={divStyle}>
          ...
          <p css={pStyle}>
            트레이너 권한 신청은 단순한 온라인 절차가 아닙니다. 당사는 오프라인
            면접 및 자격
            <br />
          ...
          <ul css={listStyle}>
            ...
            <li>
              무분별한 신청은 사이트 운영에 방해가 되며, 관리자에 의해 제한
              조치가 이루어질 수 있습니다.
            </li>
            <li>트레이너 권한은 관리자의 승인 이후에 부여됩니다.</li>
            <li>
              허위 정보 신청은 자동 반려되며, 이후 재신청이 제한될 수 있습니다.
            </li>
          </ul>
          <p css={pStyle}>
            위 내용을 충분히 이해하고, 진지하게 신청하시겠습니까?
          </p>
